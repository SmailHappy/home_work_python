def export():
    ...
    if format_knigi == '1':
        with open('home_work/dz_7/phone_book.csv', 'a', encoding='utf-8') as file:
            name = input('\nВведите имя: ')
        ...
        with open('home_work/dz_7/phone_book.txt', 'a', encoding='utf-8') as file:
...
def import_cont():
    ...
    if format_knigi == '1':
        ...
        with open('home_work/dz_7/phone_book.csv', 'r', encoding='utf-8') as file:
            for line in file:
        ...
        print("\nФамилия\t\tИмя\t\tНомер Телефона\n")
        with open('home_work/dz_7/phone_book.txt', 'r', encoding='utf-8') as file:
            for line in file:
                import_cont = line.split(',')
                print('\t\t'.join(import_cont),end='')
        print('\n')
